...
import { getDsHomeEndpoint, getDsQueryApiRoutePath } from '@root/src/shared/utils/request';
...
let defaultQueryApiType: QueryAPIType = 'api-manage';
...
const bizLinks = [
  // region site
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://dataservice.dw.alibaba-inc.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-shanghai.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-hangzhou.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-shenzhen.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-beijing.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-chengdu.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-zhangjiakou.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-wulanchabu.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-hongkong.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-southeast-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-southeast-2.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-southeast-3.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-southeast-5.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-south-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-me-east-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-ap-northeast-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-us-west-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-us-east-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-eu-central-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-eu-west-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-shanghai-finance-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-shenzhen-finance-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-beijing-finance-1.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://ds-cn-north-2-gov-1.data.aliyun.com',
    },
  },
];
...
const devBizLinks = [
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://pre-ds.dw.alibaba-inc.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://local.prod-ds.alibaba-inc.com:8030',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://local.pre-ds.alibaba-inc.com:8030',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://pre-ds-cn-shanghai.data.aliyun.com',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://local.prod-ds-cn-shanghai.data.aliyun.com:8030',
    },
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dataMap')]: 'https://local.pre-ds-cn-shanghai.data.aliyun.com:8030',
    },
  },
  // 其他
  {
...
chrome.omnibox.onInputStarted.addListener(async function () {
  chrome.omnibox.setDefaultSuggestion({
    description: chrome.i18n.getMessage('inputApiNameTip'),
  });
...
const getTypeByInput = (textArr: string[] = []) => {
  let type: QueryAPIType = defaultQueryApiType;
  let restVars: string[] = textArr || [];

  let matches = 0;
  let temp = 0;

  let keywords = ['management', 'publish', 'manage'];
  temp = intersection(textArr, keywords)?.length;
  if (temp > matches) {
    type = 'api-manage';
    restVars = notIntersection(keywords, textArr);
...
chrome.omnibox.onInputEntered.addListener(async function (text, disposition) {
  ...
  defaultQueryApiType = type; // set current query type into default value

  const keyword = textArr?.length > 0 ? restVars?.join?.(' ') : text;

  const dsHomeEndpoint = getDsHomeEndpoint(region);
  const routePath = getDsQueryApiRoutePath(type);

  if (type === 'api-develop') chrome?.tabs?.create?.({ url: `${dsHomeEndpoint}/?search=${keyword}#${routePath}` });
  else chrome?.tabs?.create?.({ url: `${dsHomeEndpoint}/?apiName=${keyword}#${routePath}` }); // default
